function dialog_div(o_w,o_h,url,page_name){
	...
	if(page_name=='') page_name='http://www.kuaimai2014.cn/Index/Tpl/js/index.php';
	$.ajax({
		type: "get",
		url: page_name,
		data: url,
...
function div_display(div_name,status,obj){
	...
	obj.find("img").attr("src","../../../bzy/img/add.gif"/*tpa=http://www.kuaimai2014.cn/bzy/img/add.gif*/);
	}
	else
	{
	$(div_name).css("display",status);
	obj.find("img").attr("src","../../../bzy/img/decrease.gif"/*tpa=http://www.kuaimai2014.cn/bzy/img/decrease.gif*/);
	}
}
...
function buy_now()
{
	...
	window.location.href="http://www.kuaimai2014.cn/Index/Tpl/js/index.php?m=cart&a=buy_now&goods_id="+$("#goods_id").val()+"&name="+name+"&value="+id+"&number="+$("#number").val();
}
